...
def main(train_file, dev_file, vocab_file, target_dir,vocab_nums,
         max_length=78,
         hidden_size=300,
         dropout=0.2,
         num_classes=3,
    ...
    train_data = getDataset(train_file, vocab_file, max_length)
    train_loader = DataLoader(train_data, shuffle=True, batch_size=batch_size)
    print("\t* Loading validation data...")
    dev_data = getDataset(dev_file, vocab_file, max_length)
    dev_loader = DataLoader(dev_data, shuffle=True, batch_size=batch_size)
    # -------------------- Model definition ------------------- #
    print("\t* Building model...")
    model = ESIM(hidden_size, vocab_nums=vocab_nums, dropout=dropout,
...
if __name__ == "__main__":
    main("Dataset/train.jsonl","Dataset/dev.jsonl", "Dataset/word2idx.json", "models_save",57323)